...
public class LocalidadeCrudServiceTest {

    @InjectMocks
    private LocalidadeCrudService service;
    ...
    @BeforeEach
    void initTests() {
        mapper = new LocalidadeMapper(new ModelMapper());
        service = new LocalidadeCrudService(repository, mapper);
    }
    ...
    @Test
    void read() {
        when(repository.findById(any())).thenReturn(Optional.of(new Localidade()));
    ...
    void update() {
        ...
        var response = service.update(new Localidade(), 1L);
    ...
    void updateWithNoData() {
        ...
        assertThrows(DataNotFoundException.class, () -> service.update(new Localidade(), 1L));
    }
    ...
    void search() {
        ...
        .thenReturn(List.of(new Localidade()));

        var specs = mock(LocalidadeSpecification.class);
